...
prompt_parts = [
  "input: write a random advice by masculinesage twitter account.",
  ...
  "input: write a random advice by masculinesage twitter account.write a random advice by masculinesage twitter account.",
